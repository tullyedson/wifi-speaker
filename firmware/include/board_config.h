...
constexpr const char* firmware = "spotpear-ball-v2/0.2.0";
...
constexpr const char* firmware = "waveshare-s3-audio/0.2.0";
...
constexpr const char* firmware = "muse-luxe/0.2.0";
